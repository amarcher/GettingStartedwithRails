...
RSpec.describe Comment, :type => :model do
  it "will create a new comment in the db with provided commenter and body" do
  ...
  describe '#commenter' do
    it 'should return a string (eq to the comment\'s commenter)' do
  ...
  describe '#body' do
    it 'should return a string (eq to the comment\'s body)' do
